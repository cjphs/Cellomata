    ...
    if l == "\n" or l == "":
        ...
        if interpreter_mode == MODE.READ_STATES:
            ...
            if len(l) > 1 and l[1] == "if":
                ...
                rules.add_rule(state_being_defined, transformation(l[0], locality_check_type, l[3], int(count)))
            else:
                if len(l) == 1 or l[1] == "otherwise":
                    rules.add_rule(state_being_defined, transformation(l[0], "", "always"))
                    interpreter_mode = MODE.SKIP
